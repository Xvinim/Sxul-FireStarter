...
{
    internal class TheTwinsRework : GlobalNPC
    {
        public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
        {
            ...
            if (npc.type == NPCID.Retinazer || npc.type == NPCID.Spazmatism)
            {
                ...
                npcLoot.Add(ItemDropRule.ByCondition(new Conditions.IsExpert(), ModContent.ItemType<CrescentRose>(), chanceNumerator: 4, chanceDenominator: 1000));
            }
        }
    }
}
