...
{
    internal class PrimeRework : GlobalNPC
    {
        public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
        {
            ...
            if (npc.type == NPCID.SkeletronPrime)
            {
                ...
                npcLoot.Add(ItemDropRule.ByCondition(new Conditions.IsExpert(), ModContent.ItemType<CrystallineSealedBladeMurakumo>(), chanceNumerator: 4, chanceDenominator: 1000));
            }
        }
    }
}
