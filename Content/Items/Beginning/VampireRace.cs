...
{
    internal class VampireRace : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (modPlayer.isDryad || modPlayer.isLizhard || modPlayer.isHuman || modPlayer.isElf)
            {
                return false;
            }
            else
            {
                modPlayer.isVampire = true;
                return true;
            }
        }
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<HumanRace>());
            r.Register();
