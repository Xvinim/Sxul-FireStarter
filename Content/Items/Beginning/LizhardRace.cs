...
{
    internal class LizhardRace : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (modPlayer.isDryad || modPlayer.isHuman || modPlayer.isVampire || modPlayer.isElf)
            {
                return false;
            }
            else
            {
                modPlayer.isLizhard = true;
                return true;
            }
        }
        ...
        public override void AddRecipes()
        {
            ...
            r1.AddIngredient(ModContent.ItemType<HumanRace>());
            r1.Register();
